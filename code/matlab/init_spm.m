...
if isempty(SPM_PATH)
    ...
    possible_paths = {
        '~/Desktop/Research/ULAB/spm12'
        '~/Documents/MATLAB/spm12'
        '~/Documents/MATLAB/spm'
...
code_dir = fileparts(script_dir);  % Go up one level from code/matlab/ to code/
DATASET_ROOT = fileparts(code_dir);  % Go up one more level to dataset root
